...
# Defaults point at Groq's free tier hosting Moonshot's Kimi K2 (OpenAI-compatible tool calling).
LLM_BASE_URL = _get("VIGIL_LLM_BASE_URL", "https://api.groq.com/openai/v1")
LLM_MODEL = _get("VIGIL_LLM_MODEL", "moonshotai/kimi-k2-instruct-0905")
